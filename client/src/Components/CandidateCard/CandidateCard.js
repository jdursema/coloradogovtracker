...
export const CandidateCard = (props) => {
  ...
  return (
    <div className = "card">
      ...
      <p className = "center party"
        style = {{color: partyColor(props.info.party)}}>
        <strong>{props.info.party}</strong></p>
    
      <div className = "card-row">
        <div className = "card-icon">
          <img src = {upArrow} alt = "up Arrow" /> </div>
        <div className = "card-row-text">
          <div className = "card-row-big-text">
            {props.info.contributionTotal.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
          </div>
      ...
      <div className = "card-row">
        ...
        <div className = "card-row-text">
          <div className = "card-row-big-text">
            {props.info.expenditureTotal.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
          </div>
